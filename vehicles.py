...
Author: Gab Yanqui
Date:02/20/2023
Purpose: Improve my ability to use dictionaries in a Python program.
"""
"""Write a program that stores information about vehicles in a Python dictionary.
Your program must ask a user to enter a vehicle identification number (VIN), then
find that VIN in the dictionary, and print the manufacturer, model, and color of
the vehicle.
"""
...
def main():
    ...
    if vin in vehicles_dict:
        ...
        MANUFACTURER_INDEX = value[MANUFACTURER_INDEX]
        ...
        print(MANUFACTURER_INDEX, MODEL_INDEX, COLOR_INDEX)
