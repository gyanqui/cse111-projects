"""
File: L07 Prepare: Checkpoint
Author: Gab Yanqui
Date: 02/14/2023
Purpose: Reinforce your understanding that numbers are passed to a
function by value and lists are passed to a function by reference.
"""
