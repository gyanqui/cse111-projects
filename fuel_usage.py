"""
File: L03 Prepare Checkpoint
Author: Gab Yanqui
Date: 01/15/2023
Purpose: Write functions with parameters and then call those
...
def main():
    ...
    fuel_gallons = float(input(
        'Enter the amount of fuel used (gallons): '))

    # Call the miles_per_gallon function and store
    # the result in a variable named mpg.
    mpg = miles_per_gallon(start, end, fuel_gallons)
    ...
    print(
        f'{mpg:.1f} miles per gallon')
    print(
        f'{lp100k:.2f} liters per 100 kilometers')

def miles_per_gallon(start, end, fuel_gallons):
    ...
    Parameters
        ...
        fuel_gallons: A fuel amount in U.S. gallons.
    Return: Fuel efficiency in miles per gallon.
    """
    mpg = (end - start) / fuel_gallons
    return mpg
